        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="panel panel-default" style="width:100%;">
                        ...
                        <input class="addCourseInput" type="text" name="quizName" placeholder="Name of quiz"></br></br>
                        1. "a question"</br></br>
                         <button class="btn btn-default">Create quiz</button>
                        </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-default" style="width:100%;">
                    ...
                    <div class="panel-body"><a href="#">a topic</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-default" style="width:100%;">
                    ...
                    <div class="panel-body">a question
                </div>
            </div>
        </div>
